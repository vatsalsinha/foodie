...
SECRET_KEY = 'cl(rvv%6(7zt^t!mqzp+3jim#t2g$%w8eu7bl3(#ch$=&ot)ri'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, "templates"), os.path.join(BASE_DIR, "videos/build")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
os.path.join(BASE_DIR, 'videos/build/static'),
]
